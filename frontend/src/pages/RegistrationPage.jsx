        ...
        <AppLayout>
            <div className="space-y-4 md:space-y-6 max-w-4xl mx-auto px-0">
                ...
                <WingModal
                    ...
                    wingForm={wingForm}
                    setWingForm={setWingForm}
                    floorInput={floorInput}
                    setFloorInput={setFloorInput}
                    currentWingFloors={currentWingFloors}
                    editingFloorIndex={editingFloorIndex}
                    onAddFloor={handleAddOrUpdateFloorRow}
                    onEditFloor={handleEditFloorRow}
                    onDeleteFloor={handleDeleteFloorRow}
