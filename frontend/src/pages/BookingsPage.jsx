...
export default function BookingsPage() {
    ...
    const handleAddBookingFromModal = () => {
        ...
        if (bookingForm.enquiryId) {
            updateEnquiry(bookingForm.enquiryId, { status: "BOOKED" })
        }
                                ...
                                <nav className="flex gap-4 -mb-px">
                                    {selectedUnit.status === FLAT_STATUS.VACANT && (
                                        <button
                                            ...
                                            className={`px-1 py-3 font-medium text-sm border-b-2 transition ${activeTab === "book"
                                    ...
                                    {selectedUnit.status === FLAT_STATUS.BOOKED && (
                                        <>
                                            <button
                                                ...
                                                className={`px-1 py-3 font-medium text-sm border-b-2 transition ${activeTab === "register"
                                                    ? "border-indigo-600 text-indigo-600"
                                                    : "border-transparent text-gray-600 hover:text-gray-900"
                                                    }`}
                                            >
                                            ...
                                            <button
                                                ...
                                                className={`px-1 py-3 font-medium text-sm border-b-2 transition ${activeTab === "cancel"
                                                    ? "border-indigo-600 text-indigo-600"
                                                    : "border-transparent text-gray-600 hover:text-gray-900"
                                                    }`}
                                            >
