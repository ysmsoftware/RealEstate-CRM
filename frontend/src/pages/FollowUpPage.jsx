        ...
        return (
            <tr>
                <td colSpan="7" className="px-4 md:px-6 py-8 text-center text-gray-500 text-sm md:text-base">
                    {viewMode === VIEW_MODES.TODAY ? "No tasks for today" : "No completed tasks"}
                </td>
            </tr>
        )
    }
...
export default function FollowUpPage() {
    ...
    const displayFollowUps = useMemo(() => {
        if (viewMode === VIEW_MODES.TODAY) {
            // Today logic: Date <= Today OR Overdue
        ...
        // Completed logic: Date > Today (Future tasks are considered "done" for today)
        return enrichedFollowUps
        ...
        <AppLayout>
            <div className="space-y-4 md:space-y-6">
                ...
                <div className="flex gap-2 flex-wrap">
                    ...
                    <Button
                        onClick={() => setViewMode(VIEW_MODES.COMPLETED)}
                        variant={viewMode === VIEW_MODES.COMPLETED ? "primary" : "secondary"}
                        className="text-sm flex-1 sm:flex-none"
                    >
                        Completed Tasks
                    </Button>
