...
export default function SignUpPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Basic validation
        const requiredFields = ["orgName", "orgEmail", "username", "password", "email", "fullName", "mobileNo"]
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    accept="image/*"
                                    onChange={handleChange}
                                    className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all duration-200 hover:bg-white file:mr-3 file:rounded-lg file:border-0 file:bg-indigo-100 file:px-3 file:py-2 file:text-sm file:font-medium file:text-indigo-700"
                                />
                                {formData.logo && (
                                    <p className="mt-2 text-xs text-gray-500">{formData.logo.name}</p>
                                )}
                            </div>
