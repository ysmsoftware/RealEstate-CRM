...
const enquiry1 = {
  ...
  leadCity: "Mumbai",
  leadAddress: "123 Main Street, Mumbai",
  leadOccupation: "Software Engineer",
  leadCompany: "Infosys",
  propertyType: "Residential",
  property: seedData.flats[0].bhk,
  area: seedData.flats[0].area,
  budget: "₹50-60 Lakhs",
  reference: "Website",
...
const enquiry2 = {
  ...
  leadCity: "Mumbai",
  leadAddress: "456 Oak Avenue, Mumbai",
  leadOccupation: "Doctor",
  leadCompany: "Apollo Hospital",
  propertyType: "Residential",
  property: seedData.flats[1].bhk,
  area: seedData.flats[1].area,
  budget: "₹60-70 Lakhs",
  reference: "Referral",
...
const enquiry3 = {
  ...
  leadMobileNumber: "9876543213",
  leadLandlineNumber: "",
  leadEmail: "sneha@example.com",
  leadCity: "Hyderabad",
  leadAddress: "321 Elm Street, Hyderabad",
  leadOccupation: "Architect",
  leadCompany: "Design Studios",
  propertyType: "Residential",
  property: seedData.flats[20].bhk,
  area: seedData.flats[20].area,
  budget: "₹70-80 Lakhs",
...
const enquiry4 = {
  ...
  leadMobileNumber: "9876543214",
  leadLandlineNumber: "",
  leadEmail: "vikram@example.com",
  leadCity: "Delhi",
  leadAddress: "654 Maple Drive, Delhi",
  leadOccupation: "Consultant",
  leadCompany: "McKinsey",
  propertyType: "Residential",
  property: seedData.flats[5].bhk,
  area: seedData.flats[5].area,
  budget: "₹80-90 Lakhs",
  reference: "Broker",
...
const enquiry5 = {
  ...
  leadMobileNumber: "9876543216",
  leadLandlineNumber: "",
  leadEmail: "rohit@example.com",
  leadCity: "Pune",
  leadAddress: "147 Birch Street, Pune",
  leadOccupation: "Engineer",
  leadCompany: "TCS",
  propertyType: "Residential",
  property: seedData.flats[40].bhk,
  area: seedData.flats[40].area,
  budget: "₹55-65 Lakhs",
  reference: "Website",
...
const enquiry6 = {
  ...
  leadMobileNumber: "9876543218",
  leadLandlineNumber: "",
  leadEmail: "suresh@example.com",
  leadCity: "Chennai",
  leadAddress: "369 Palm Street, Chennai",
  leadOccupation: "Project Manager",
  leadCompany: "Wipro",
  propertyType: "Residential",
  property: seedData.flats[25].bhk,
  area: seedData.flats[25].area,
  budget: "₹75-85 Lakhs",
  reference: "Referral",
